 ...
 * specified {@link OnRecyclerListHomeFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class ExploreItemEventRecycleAdapter extends RecyclerView.Adapter<ExploreItemEventRecycleAdapter.ViewHolder> {

    private final ListContent.Item[] mValues;
    private final OnRecyclerListExploreFragmentInteractionListener mListener;

    public ExploreItemEventRecycleAdapter(ListContent.Item[] items, OnRecyclerListExploreFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.OnRecyclerListExploreFragmentInteraction( holder.mCategoryName.getText().toString() , id );
                }
            }
        });
    }
